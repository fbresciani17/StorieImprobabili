...
const styles = StyleSheet.create({
  ...
  item: { borderWidth: 1, borderRadius: 8, padding: 4, flexDirection: 'row', alignItems: 'center', gap: 3 },
  icon: { fontSize: 12, width: 16, textAlign: 'center' },
  itemLabel: { fontSize: 13, opacity: 0.9, width: 110 },
  itemValue: { flex: 1, fontSize: 12, fontWeight: '700' },
